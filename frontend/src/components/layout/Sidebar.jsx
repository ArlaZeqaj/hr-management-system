...
const Sidebar = () => {
    return (
        <aside className="sidebar-1">
            <h1 className="sidebar-title-1">HRCLOUDX</h1>
            <nav className="sidebar-nav-1">
                <div className="sidebar-item-1 active">
                    <span className="sidebar-indicator-1"></span>
                    <svg className="sidebar-icon-1" viewBox="0 0 24 24" fill="none" stroke="currentColor">
